...
from app.routers import auth, counterparties, portfolios, reports, alerts, agents, stress_tests, admin, regulations
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],   # open during MVP — tighten before production
