      ...
      <div className="p-8 space-y-6">
        ...
        {stats && (
          <div className="grid grid-cols-6 gap-3">
            ...
            {/* Add document */}
            <div className="card p-3 col-span-1 flex flex-col justify-center">
              <div className="label mb-1.5 text-[10px]">Add Document URL</div>
              <div className="flex gap-1.5">
                <input value={addUrl} onChange={e => setAddUrl(e.target.value)}
                  onKeyDown={e => e.key === 'Enter' && addDocument()}
                  placeholder="https://…finma…pdf"
                  className="flex-1 border border-border rounded px-2 py-1 text-xs focus:outline-none focus:border-ink" />
                <button onClick={addDocument} disabled={adding || !addUrl.trim()}
